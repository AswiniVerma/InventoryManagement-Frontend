...
function ToolFound() {
  const url = api_endpoints.toolFound
  ...
  return (
    ...
    <div className='text-center'>
      <h1 className='text-4xl flex justify-center font-bold'> Enter the number of tools found:</h1>
